<div id="popup-<?= $rev['reviewID'] ?>" class="popup" style="display:none;">
    <div class="popup-content">
        <span class="close-btn" onclick="togglePopupEdit('popup-<?= $rev['reviewID'] ?>')">&times;</span>
        ...
        <form method="post" action="">
            ...
            <textarea id="edit_review_text" name="edit_review_text" rows="4"
                required><?= htmlspecialchars($rev["review"]); ?></textarea>
            <br>
